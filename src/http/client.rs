...
impl HttpClient {
    ...
    fn build_client_with_config(http_config: &HttpConfig) -> Result<ClientWithMiddleware> {
        ...
        let mut client_builder = reqwest::Client::builder()
            .user_agent(format!("replicate-rs/{}", crate::VERSION));
    ...
    pub async fn post<T: Serialize>(&self, path: &str, body: &T) -> Result<Response> {
        self.execute_request_with_json(Method::POST, path, body).await
    }
    ...
    pub async fn put<T: Serialize>(&self, path: &str, body: &T) -> Result<Response> {
        self.execute_request_with_json(Method::PUT, path, body).await
    }
    ...
    pub async fn post_multipart(
        ...
        self.execute_multipart_request(Method::POST, path, form).await
    }
...
mod tests {
    ...
    fn test_retry_configuration() {
        ...
        let result = client.configure_retries(
            5,
    ...
    fn test_timeout_configuration() {
        ...
        assert_eq!(returned_timeout_config.connect_timeout, Some(Duration::from_secs(15)));
        assert_eq!(returned_timeout_config.request_timeout, Some(Duration::from_secs(90)));
    }
    ...
    fn test_timeout_reconfiguration() {
        ...
        assert_eq!(initial_config.connect_timeout, Some(Duration::from_secs(30)));
        assert_eq!(initial_config.request_timeout, Some(Duration::from_secs(60)));
        
        // Configure new timeouts
        let result = client.configure_timeouts(
        ...
        assert_eq!(updated_config.request_timeout, Some(Duration::from_secs(120)));
    }
    ...
    fn test_http_config_accessors() {
        ...
        assert_eq!(returned_config.timeout.connect_timeout, Some(Duration::from_secs(10)));
        assert_eq!(returned_config.timeout.request_timeout, Some(Duration::from_secs(45)));
    }
} 